...
function add_functional_skill(skill) {
    ...
    skill.children[1].children[0].children[0].addEventListener('change', function () {
...
document.getElementsByClassName('content-form')[0].addEventListener('submit', function (e) {
    ...
    // Заполнение данными
    formData.append('save_character', document.getElementsByName('save_button')[0]); //Кнопка
