...
<body>
    ...
    <main class="content">
        <div class="weapons-section">
            <form action="main_admin.php" method="post" class="weapons-form-add" enctype="multipart/form-data">
                <h2>Добавление оружия</h2>
                <div class="weapons-form-add-header">
                    <div class="weapons-form-add-header-logo">
                        <div class="weapons-form-add-header-logo-icon">+
                            <input type="file" name="weapons_image" class="weapons-form-add-header-logo-icon-image" accept=".jpg, .png, .jpeg" required>
                        </div>
                    </div>
                    <div class="weapons-form-add-header-info">
                        <span class="weapons-form-add-header-info-title">Название:</span>
                        <input type="text" name="weapons_name" class="weapons-form-add-header-info-name" required>
                    </div>
                    <div class="weapons-form-add-header-info">
                    ...
                    <div class="weapons-form-add-header-info">
                        ...
                        <select name="weapons_class" class="weapons-form-add-header-info-name" required>
                            <option value="">Выберите</option>
                            <option value="one-handed_sword">Одноручное</option>
                            <option value="two-handed_sword">Двуручное</option>
                            <option value="catalyst">Катализатор</option>
                            <option value="archery">Лук</option>
                ...
                <div class="weapons-form-add-info">
                    <div class="weapons-form-add-info-section">
                        ...
                        <textarea name="weapons_info[]" class="weapons-form-add-info-section-text" required></textarea>
                    </div>
                    <div class="weapons-form-add-info-section">
                ...
                <div class="weapons-form-add-button">
                    ...
                    <input type="submit" value="Добавить" name="weapons_submit">
                </div>
            </form>
        ...
        <div class="weapons-section-line"></div>

        <div class="weapons-section">
            <h2>Оружие</h2>
            <div class="weapons-section-filter">
                <span class="weapons-section-filter-item active_filter">Все</span>
                <div class="weapons-section-filter-line"></div>
                <span class="weapons-section-filter-item">1 <img src="../../assets/image/imgElem/star.svg" alt="#"></span>
                <div class="weapons-section-filter-line"></div>
                <span class="weapons-section-filter-item">2 <img src="../../assets/image/imgElem/star.svg" alt="#"></span>
                <div class="weapons-section-filter-line"></div>
                <span class="weapons-section-filter-item">3 <img src="../../assets/image/imgElem/star.svg" alt="#"></span>
                <div class="weapons-section-filter-line"></div>
                <span class="weapons-section-filter-item">4 <img src="../../assets/image/imgElem/star.svg" alt="#"></span>
                <div class="weapons-section-filter-line"></div>
                <span class="weapons-section-filter-item">5 <img src="../../assets/image/imgElem/star.svg" alt="#"></span>
            </div>
            <div class="weapons-section-all">
                <?php
                if(mysqli_num_rows($weapons) > 0){
                    while($weapon = mysqli_fetch_array($weapons)){
                    ?>
                        <div class="weapons-section-all-weapon">
                            <div class="weapons-section-all-weapon-head">
                                <img src="../../<?php echo $weapon['path']; ?>" alt="#" class="weapons-section-all-weapon-head-image <?php echo $weapon['rare']; ?>">
                                <span class="weapons-section-all-weapon-head-name"><?php echo $weapon['name']; ?></span>
                            </div>
                            <span class="weapons-section-all-weapon-info"><?php echo $weapon['description']; ?></span>
                            <div class="weapons-section-all-weapon-button">
                                <form action="main_admin.php" method="post">
                                    <input type="hidden" name="id_weapon" value="<?php echo $weapon['id']; ?>">
                                    <input type="hidden" name="path_weapon" value="<?php echo $weapon['path']; ?>">
                                    <input type="submit" name="weapons_delete" class="weapons_delete" value="Удалить">
                                </form>
                                <a href="update_weapons.php?id=<?php echo $weapon['id']; ?>" class="weapons_update">Редактировать</a>
                            </div>
                        </div>
                    <?php
                    }
